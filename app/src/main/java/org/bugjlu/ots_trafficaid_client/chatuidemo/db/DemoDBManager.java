package org.bugjlu.ots_trafficaid_client.chatuidemo.db;
...
import org.bugjlu.ots_trafficaid_client.chatuidemo.DemoApplication;
...
public class DemoDBManager {
    static private DemoDBManager dbMgr = null;
    ...
    public static synchronized DemoDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new DemoDBManager(MyApplication.getContext());
        }
        return dbMgr;
    }
